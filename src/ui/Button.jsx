...
export default function Button({ children, disabled, to, type }) {
  ...
  const styles = {
    ...
    secondary:
      'inline-block rounded-full font-semibold uppercase tracking-wide text-stone-400 hover:bg-stone-300 focus:bg-stone-300 hover:text-stone-800 transition-colors duration-300 hover:bg-yellow-300 focus:bg-stone-200 focus:text-stone-800 focus:outline-none focus:ring focus:ring-yellow-300 focus:ring-offset-2 disabled:cursor-not-allowed border-2 border-stone-300 px-4 py-2.5 md:px-6 md:py-3.5',
  };
